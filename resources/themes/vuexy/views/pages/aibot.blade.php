                    ...
                    <div class="row g-3">
                            ...
                            <div class="d-flex gap-3 flex-wrap">
                                @foreach (['Group', 'Personal', 'All'] as $option)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="reply_when" id="reply_{{ $option }}" value="{{ $option }}"
                                               {{ $device->reply_when == $option ? 'checked' : '' }}>
                                        <label class="form-check-label" for="reply_{{ $option }}">{{ __($option) }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="reject_call">{{ __('Reject Call Automatically') }}</label>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="can_read_message">{{ __('Bot can read messages') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="bot_typing">{{ __('Bot typing indicator') }}</label>
                            </div>
                        </div>
