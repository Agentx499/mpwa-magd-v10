                    ...
                    <div class="row g-3">
                            ...
                            <div class="d-flex gap-3 flex-wrap">
                                <?php $__currentLoopData = ['Group', 'Personal', 'All']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="reply_when" id="reply_<?php echo e($option); ?>" value="<?php echo e($option); ?>"
                                               <?php echo e($device->reply_when == $option ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="reply_<?php echo e($option); ?>"><?php echo e(__($option)); ?></label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="reject_call" id="reject_call"
                                       <?php echo e($device->reject_call == 1 ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="reject_call"><?php echo e(__('Reject Call Automatically')); ?></label>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="can_read_message" id="can_read_message"
                                       <?php echo e($device->can_read_message == 1 ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="can_read_message"><?php echo e(__('Bot can read messages')); ?></label>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="bot_typing" id="bot_typing"
                                       <?php echo e($device->bot_typing == 1 ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="bot_typing"><?php echo e(__('Bot typing indicator')); ?></label>
                            </div>
                        </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-12 name-field d-none">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                   name="<?php echo e($key); ?>_name"
                                                   class="form-control"
                                                   value="<?php echo e($device->{$key.'_name'} ?? ''); ?>"
                                                   placeholder="Ex: <?php echo e($key); ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                   name="<?php echo e($key); ?>_api"
                                                   class="form-control"
                                                   value="<?php echo e($device->{$key.'_api'} ?? ''); ?>"
                                                   placeholder="<?php echo e($label); ?> API Key">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
   document.addEventListener('DOMContentLoaded', function () {
      ...
      function toggleFields() {
         ...
         document.getElementById('bot-options').style.display = sel && sel.value!=='0' && !bex ? 'block' : 'none';
         document.getElementById('bexa-options').style.display = bex ? 'block' : 'none';
         toggleBexaCustom();
         toggleProductFields();
...
<?php /**PATH E:\projects\mpwa-magd-v10.0.0\resources\themes/vuexy/views/pages/aibot.blade.php ENDPATH**/ ?>